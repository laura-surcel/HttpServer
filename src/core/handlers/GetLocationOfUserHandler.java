...
public class GetLocationOfUserHandler implements HttpHandler 
{
	@Override
	public void handle(HttpExchange t) throws IOException 
	{
    	...
    	System.out.println("GetLocationOfUserHandler: " + body);
        ...
        try 
    	{
			...
			response = MySqlEngine.getInstance().getLocationOfUser(deviceId) + "\n";
		} 
