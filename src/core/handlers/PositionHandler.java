...
public class PositionHandler implements HttpHandler 
{
	...
	{
		System.out.println("PositionHandler: " + t.getRequestMethod());
        ...
        try 
    	{
			...
			ClientManager.getInstance().updateClient(deviceId, lat, longit);
			response = ClientManager.getInstance().getNeighbours(deviceId) + "\n";
		} 
